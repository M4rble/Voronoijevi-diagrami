...
cikel <- lapply(velikosti,
                   . %>% sprintf('files/rezultati_cikel_do_%d.tsv', .) %>%
...
graf_cikel <- lapply(1:length(velikosti),
                        function(i)
                          ...
                          ggtitle(sprintf('Povprečne velikosti celic glede na število središč za cikle z %d vozlišči', velikosti[i])) + 
